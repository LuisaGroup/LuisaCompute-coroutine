...
//                });
    ...
    auto transform_pipeline = ir::luisa_compute_ir_transform_pipeline_new();
    ir::luisa_compute_ir_transform_pipeline_add_transform(transform_pipeline, "canonicalize_control_flow");
    ir->get()->module = ir::luisa_compute_ir_transform_pipeline_transform_module(transform_pipeline, ir->get()->module);
    ir::luisa_compute_ir_transform_pipeline_destroy(transform_pipeline);
