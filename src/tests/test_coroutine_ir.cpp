...
int main(int argc, char *argv[]) {
    ...
    Coroutine coro = [](Var<CoroFrame> &frame, BufferUInt x_buffer) noexcept {
        ...
        auto shader = device.compile(kernel, {.name = R"(C:\OldNew\Graphics-Lab\LuisaCompute\LuisaCompute-coroutine\entry_debug)"});
        ...
        auto resume_shader = device.compile(resume_kernel, {.name = R"(C:\OldNew\Graphics-Lab\LuisaCompute\LuisaCompute-coroutine\resume_debug)"});
